  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0f', color: 'white', fontFamily: 'sans-serif' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          {username ? (
            <>
              ...
              <button onClick={() => navigate('/events')} style={navBtn('#7c3aed')}>
                🎟️ Events
              </button>
              <button onClick={() => navigate('/my-bookings')} style={navBtn('#0891b2')}>
                🎫 Bookings
              </button>
              ...
              <button onClick={handleLogout} style={navBtn('#dc2626')}>
                Logout
              </button>
            </>
          ) : (
      ...
      <div style={{
        ...
        textAlign: 'center', maxWidth: '1140px',
